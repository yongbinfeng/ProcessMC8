...
{ 
  ...
  char* aa2 = "hptudfinale";
  char* bb2 = "hptallfinale";
  ...
  char* aa4 = "hptgbbfinale";
  char* bb4 = "hptallfinale";
  ...
  t->SetTextColor(1);
  t->DrawLatex(-80,0.90,"g ");
  t->SetTextColor(2);
  t->DrawLatex(-80,0.85,"ud ");
  t->SetTextColor(3);
  t->DrawLatex(-80,0.8,"b ");
  t->SetTextColor(4);
  t->DrawLatex(-80,0.75,"g to b ");
  t->SetTextColor(5);
  t->DrawLatex(-80,0.7,"s ");
  t->SetTextColor(6);
  t->DrawLatex(-80,0.65,"c ");
